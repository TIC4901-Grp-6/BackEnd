...
$db = mysqli_connect("localhost", "root", "mysql", "uploadimagetest");
...
// to delete pictures
	...
	{
		$querySelect = "select * from image where id = ".$_GET['deleteid'];
		...
		{
			$liveSqlQQ = "delete from image where id = ".$fetchRecords['id'];
